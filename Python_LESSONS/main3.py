...
# Load PDF document
loader = PyPDFLoader("D:\Python_LESSONS\Python Programming.pdf")
data = loader.load()
...
def generate_topics_list(pdf_path):
    ...
    topics = ["Variables & Data Types", "Introducing Lists", "Working with Lists", "if statements", "Dictionaries", "User Input & while loop", "Functions", "Classes", "File & Exception"]
    return topics
